...
def component_to_epsilon_femwell():
    """TODO: Uses gdsfactory meshing + femwell physical tagging + export to a cartesian grid to define the (3, xx, yy, zz) array of permittivity values"""
...
def plot_epsilon(
    ...
    if x is not None:
        ...
        plt.xlabel("x")
        plt.ylabel("y")
        plt.title(f"Epsilon Distribution at z = {z}")
