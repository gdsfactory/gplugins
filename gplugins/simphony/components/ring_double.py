...
from gplugins.simphony.components.coupler_ring import coupler_ring
from gplugins.simphony.components.straight import (
    straight as straight_function,
)
from gplugins.simphony.plot_circuit import plot_circuit
from gplugins.simphony.types import ModelFactory
...
def ring_double(
    ...
    .. plot::
        ...
        import gplugins.simphony as gs
        import gplugins.simphony.components as gc
